...
def main():
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("Training vs Validation Loss of Impp")
    plt.legend()
    plt.tight_layout()
    plt.savefig("06_graphs/impp_train_vs_val_loss.png")
    plt.close()
    ...
    plt.title("Actual vs Predicted Impp (Test Set)")
    plt.tight_layout()
    plt.savefig("06_graphs/predictedImpp_vs_actualImpp_test.png")
    plt.close()

    # 11. Append test metrics to file
    results_path = "05_ann/metrics/impp_metrics.txt"
    append_metrics(
    ...
    model.save("05_ann/models/impp_model.h5")

    # 13. Save scalers
    joblib.dump(scaler_X, "05_ann/models/impp_scaler_X.pkl")
    joblib.dump(scaler_y, "05_ann/models/impp_scaler_y.pkl")
